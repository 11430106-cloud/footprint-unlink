...
export function Tutorial({onBack,onChecklist}:{onBack:()=>void;onChecklist:()=>void}) {
 ...
 ['開始測驗','首頁點選「開始測驗」，認識身分、位置、時間與關聯四種線索，再點「開始辨識」。'],
 ...
 ['查看結果與採取行動','完成後查看辨識力、斷鏈能力、回查能力與總分，依照三項建議檢查自己的公開資料。分數代表作答表現，不等於真實帳號安全程度。'],
 ...
 <div className="guide-note"><h2>計分與隱私</h2><p>辨識 4 題占 40 分、斷鏈 3 題占 40 分、回查 1 題占 20 分。各階段依答對題數等比例換算，再四捨五入為整數；總分為三項分數相加。80 分以上為「斷鏈高手」、60–79 分為「足跡觀察員」、59 分以下為「線索待清理」。</p><p>測驗不要求姓名、帳號或上傳資料，不使用外部 AI 分析，也不設廣告追蹤碼。答案與分數只在瀏覽器記憶體計算，重新整理或關閉頁面即不保留。</p></div>
